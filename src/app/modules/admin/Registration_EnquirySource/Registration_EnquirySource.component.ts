...
@Component({
selector: 'app-Registration_EnquirySource',
templateUrl: './Registration_EnquirySource.component.html',
styleUrls: ['./Registration_EnquirySource.component.css'],
providers: [
...
export class Registration_EnquirySourceComponent implements OnInit {
...
constructor(public Internship_Service_:Internship_Service,public Student_Service_:Student_Service, private route: ActivatedRoute, private router: Router,public dialogBox: MatDialog) 
{   }
ngOnInit() 
{
...
Page_Load()
{
    ...
    this.Get_Menu_Status(51,this.Login_User);
        ...
        
{
    ...
    this.Enquiry_Source_Data.unshift(Object.assign({}, this.Enquiry_Source_Temp));
...
View_Details(Enquiry_Source_Id)
{
    for (var i = 0; i < this.Enquiry_Source_Data.length; i++) {
        if (Enquiry_Source_Id== this.Enquiry_Source_Data[i].Enquiry_Source_Id)
        this.Enquiry_Source_Search=this.Enquiry_Source_Data[i];
    } 
this.Search_Registration_Report(Enquiry_Source_Id,)
}
...
var value = 1, dept_id=0,User_Id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
    ...
    this.Student_Service_.Student_Registration_By_Enquirysource(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), branch_id, look_In_Date_Value,this.Login_User)
.subscribe(Rows => 
{
...
Search_Registration_Report(Enquiry_Source_Id)
{
...
var value = 1, dept_id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
    ...
    if (this.Enquiry_Source_Search != undefined && this.Enquiry_Source_Search!=null)
    if (this.Enquiry_Source_Search.Enquiry_Source_Id != undefined && this.Enquiry_Source_Search.Enquiry_Source_Id != null)
    ...
    this.Student_Service_.Student_Registration_By_Enquirysource_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'),
     moment(this.Search_ToDate).format('YYYY-MM-DD'), value, search_name_, dept_id,branch_id, Enquiry_Source_Id,  
     look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop)
.subscribe(Rows => 
{
