...
@Component({
    selector: "app-Student_Followup_Report",
    templateUrl: "./Student_Followup_Report.component.html",
    styleUrls: ["./Student_Followup_Report.component.css"],
    providers: [
        {
            provide: DateAdapter,
...
export class Student_Followup_ReportComponent implements OnInit {
    ...
    Remove_Old_User_Details: Boolean = false;
    ...
    Search_Student_Report() {
        var value = 1,
            ...
            To_User_Id = 0,
            Register_Value = 1,
            Department_Status_Id = 0,Date_value_=1;
        ...
        if (this.Searchdate_By_ != undefined && this.Searchdate_By_ != null)
        if (
            this.Searchdate_By_ != undefined &&
            this.Searchdate_By_ != null &&
            this.Searchdate_By_ != ""
        )
        Date_value_ = this.Searchdate_By_;




        this.issLoading = true;
        this.Student_Service_.Search_Student_Report_Followup(
...
var Remove_Old_User_Value=0;
        ...
        if (this.Remove_Old_User_Details == true) Remove_Old_User_Value = 1;
        ...
        //    }
        {
            ...
            this.Student_.Remove_Old_User_Value = Remove_Old_User_Value;
    ...
    Close_Click() {
        ...
        this.Remove_Old_User_Details=false;
    }
    Delete_Student() {
