...
this.Client_Accounts_Service_.Search_Agent(varSearch_Client_Accounts,Account_Group_Id,this.Pointer_Start_,this.Pointer_Stop_,this.Page_Length_).subscribe(Rows => {
...
Delete_Agent(Client_Accounts_Id_,index)
{
...
this.Client_Accounts_Service_.Delete_Agent(Client_Accounts_Id_).subscribe(Delete_status => {
...
this.Client_Accounts_.Account_Group_Id= 13;
this.Client_Accounts_Service_.Save_Agent(this.Client_Accounts_).subscribe(Save_status => {
...
Edit_Agent(Client_Accounts_e:any,index)
{
