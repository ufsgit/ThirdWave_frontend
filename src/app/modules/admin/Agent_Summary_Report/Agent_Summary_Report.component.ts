...
@Component({
  selector: 'app-Agent_Summary_Report',
  templateUrl: './Agent_Summary_Report.component.html',
  styleUrls: ['./Agent_Summary_Report.component.css'],
providers: [
 ...
 export class Agent_Summary_ReportComponent implements OnInit {
...
Page_Load()
{
  ...
  // this.Search_Student_Report();
   ...
   this.Show_FollowUp=false
    ...
    this.Get_Menu_Status(182,this.Login_User);
...
Export()
{
        this.Student_Service_.exportExcel(this.Student_Data_Search,'Agent_Summary_Report')
...
var Entry_type_=0;
    ...
    this.Student_Service_.Search_Agent_Summary_Report(Intake_Id, Intake_Year_Id, this.Login_User,this.View_Type_,Entry_type_,UserType_Value,Country_Id,search_name_).subscribe(Graph_Status => 
{  debugger
    this.issLoading = false;
