...
@Component({
selector: 'app-Agent_Student',
templateUrl: './Agent_Student.component.html',
styleUrls: ['./Agent_Student.component.css'],
providers: [
...
export class Agent_StudentComponent implements OnInit {
...
var value = 1, dept_id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
    ...
    this.issLoading = true;
    debugger
    this.Student_Service_.View_Detail_agent( dept_id,branch_id,User_Id,this.Login_User)
.subscribe(Rows => 
{
    debugger
    //log(Rows)
...
FollowUp_Summary()
{
    ...
    this.Student_Service_.Agent_Search_data(User_Id)
.subscribe(Rows => 
{
    debugger
    //log(Rows)
