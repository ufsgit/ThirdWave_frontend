...
@Component({
selector: 'app-Freelancer_Amount',
templateUrl: './Freelancer_Amount.component.html',
styleUrls: ['./Freelancer_Amount.component.css'],
providers: [
...
export class Freelancer_AmountComponent implements OnInit {
...
FollowUp_Summary()
{
    ...
    this.Student_Service_.Freelancer_Search_Amount_Details(User_Id,this.Login_User)
.subscribe(Rows => 
{
    debugger
    //log(Rows)
