...
@Component({
selector: 'app-Freelancer_Dashboard',
templateUrl: './Freelancer_Dashboard.component.html',
styleUrls: ['./Freelancer_Dashboard.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
    ],
})
export class Freelancer_DashboardComponent implements OnInit {
...
debugger
            ...
            this.Student_Service_.Get_Dashboard_Count_Freelancer(this.Login_User,moment(this.Search_FromDate).format("YYYY-MM-DD"),
