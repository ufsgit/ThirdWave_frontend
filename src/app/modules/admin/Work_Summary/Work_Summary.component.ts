...
@Component({
selector: 'app-Work_Summary',
templateUrl: './Work_Summary.component.html',
styleUrls: ['./Work_Summary.component.css'],
providers: [
...
export class Work_SummaryComponent implements OnInit {
...
//     this.Student_Service_. Search_Work_Summary(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), User_Id)
// .subscribe(Rows => 
// {
