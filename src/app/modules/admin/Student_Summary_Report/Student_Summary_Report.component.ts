...
@Component({
selector: 'app-Student_Summary_Report',
templateUrl: './Student_Summary_Report.component.html',
styleUrls: ['./Student_Summary_Report.component.css'],
providers: [
...
export class Student_Summary_ReportComponent implements OnInit {
...
Page_Load()
{
   ...
   this.Get_Menu_Status(35,this.Login_User);
...
Export()
{
        this.Student_Service_.exportExcel(this.Student_Data_Search,'Student_Summary_Report')
...
var value = 1, dept_id=0,User_Id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
    ...
    this.Student_Service_. Search_Student_Summary_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), value, search_name_, dept_id,branch_id, User_Id,   look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop)
.subscribe(Rows => 
{
    ...
    {
        result.push([Branchwise_data_temp[i].Department, Branchwise_data_temp[i].No_of_Students]);
    ...
    this.Branchwise_columnNames.push('Department_Name')
