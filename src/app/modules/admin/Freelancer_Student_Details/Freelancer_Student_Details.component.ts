...
@Component({
selector: 'app-Freelancer_Student_Details',
templateUrl: './Freelancer_Student_Details.component.html',
styleUrls: ['./Freelancer_Student_Details.component.css'],
providers: [
...
export class Freelancer_Student_DetailsComponent implements OnInit {
...
Page_Load()
{
    ...
    this.Get_Menu_Status(153,this.Login_User);
...
FollowUp_Summary()
{
    ...
    this.issLoading = true;
    debugger
    this.Student_Service_.Freelancer_Search_data_Details(User_Id,this.Login_User)
.subscribe(Rows => 
{
    debugger
    //log(Rows)
...
Get_Lead_Load_Data_ByUser(Login_User)
   ...
   this.Users_Data = Rows[14].slice();
   this.Users_Temp.User_Details_Id = 0;
   this.Users_Temp.Agent_Name = "All";
   this.Users_Data.unshift(Object.assign({},this.Users_Temp));
   this.Agent_Search = this.Users_Data[0];
