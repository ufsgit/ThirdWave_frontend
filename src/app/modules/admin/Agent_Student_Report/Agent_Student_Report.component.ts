...
@Component({
    selector: "app-Agent_Student_Report",
    templateUrl: "./Agent_Student_Report.component.html",
    styleUrls: ["./Agent_Student_Report.component.css"],
    providers: [
        {
            provide: DateAdapter,
...
export class Agent_Student_ReportComponent implements OnInit {
    ...
    Page_Load() {
        ...
        this.myInnerHeight = this.myInnerHeight - 160;
...
debugger
        this.Student_Service_.Agent_Search_Student_Report(
            ...
            Register_Value,UserType_Value,this.Application_Status_Search
        ).subscribe(
            (Rows) => {
                debugger 
                // log(Rows)
