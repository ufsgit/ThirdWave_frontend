...
@Component({
selector: 'app-Application_Dashboard',
templateUrl: './Application_Dashboard.component.html',
styleUrls: ['./Application_Dashboard.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
    ],
})
export class Application_DashboardComponent implements OnInit {
...
myInnerHeight: number;
  ...
  Permissions: any;
  Application_status_Id:number=0;
...
Page_Load()
{
    ...
    this.Get_Application_Dashboard_Count();
...
Get_Application_Dashboard_Count()
{
    {
            this.issLoading = true;
            
            this.Student_Service_.Get_Application_Dashboard_Count(this.Login_User)
        .subscribe(Rows => 
        {
...
Click_No6()
{
    this.Application_status_Id = 38;
    localStorage.setItem('Application_status_Id',this.Application_status_Id.toString());
