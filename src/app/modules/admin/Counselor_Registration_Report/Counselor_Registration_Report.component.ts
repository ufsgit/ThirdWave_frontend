...
@Component({
selector: 'app-Counselor_Registration_Report',
templateUrl: './Counselor_Registration_Report.component.html',
styleUrls: ['./Counselor_Registration_Report.component.css'],
providers: [
...
export class Counselor_Registration_ReportComponent implements OnInit {
...
var value = 1, dept_id=0,User_Id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
    ...
    this.Student_Service_.Search_Counselor_Registration_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'),
