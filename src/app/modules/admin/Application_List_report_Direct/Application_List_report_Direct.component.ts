...
@Component({
	selector: "app-Application_List_report_Direct",
	templateUrl: "./Application_List_report_Direct.component.html",
	styleUrls: ["./Application_List_report_Direct.component.css"],
	providers: [
		{
			provide: DateAdapter,
...
export class Application_List_report_DirectComponent implements OnInit {
...
isTypeaheadOpen = false;
	...
	Get_All_ByUser_OLD(event: any,source:number) {
		var Value = "";
...
debugger
	...
	Export() {
        ...
        this.Student_Service_.exportExcel(filteredData, 'Application Direct Report');
    }
	// Export() {
    //     // Create filtered data from Study_Receipt_Report_Data
    //     const filteredData = this.ApplicationDetails_Data.map((receipt: any, index: number) => {
    ...
    //             InvoiceNo: receipt["Voucher_No"],
    //             Student: receipt["Student"],
    //             Amount: receipt["Amount"],
    //             Mode: receipt["Mode_Name"],
    //             AdmissionNo: receipt["Admission_no"],
    //             Address: receipt["Address1"],
    //             PhoneNumber: receipt["Phone"],
    //             TaxableValue: receipt["Amount"], // If applicable, update this
    //             Gst: receipt["Gst_Percentage"],
    //             Total: receipt["Grand_Total"]
    //         };
    //     });
    
    //     // Call exportExcel with the filtered data
    //     this.Student_Service_.exportExcel(filteredData, 'Study Report');
    // }
	previous_Click() {
...
this.Search_Application_List()
	...
	Search_Application_List() {
		...
		var Is_View_ ,Enrolled_Application_View_,Department_Status_Id_ = 0,search_name_='',search_application_no_=0,look_In_Date_Value=0,Course_Id=0,Country_Id=0,University_Id=0,Intake_Id=0,Intake_Year_Id=0,Department_Status_Id=0,To_User_Id=0;
...
var Entry_type_=3;
		...
		console.log('this.To_User_Search1: ', this.To_User_Search);
		debugger
...
debugger
		this.Student_Service_.Search_Direct_Application_Report_new(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'),
			this.Login_User,
			...
			look_In_Date_Value,followup_user_selection,this.View_Type_,3,search_application_no_,To_User_Id,application_status_,
	...
	Get_Lead_Load_Data_ByUser(Login_User) {
		...
		this.Student_Service_.Get_Lead_Load_Data_ByUser(Login_User).subscribe(
			(Rows) => {
				...
				console.log('this.Users_Data1[0]: ', this.Users_Data1[0]);
