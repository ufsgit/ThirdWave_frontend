...
@Component({
selector: 'app-Userwise_Summary',
templateUrl: './Userwise_Summary.component.html',
styleUrls: ['./Userwise_Summary.component.css'],
providers: [
...
export class Userwise_SummaryComponent implements OnInit {
...
.subscribe(Rows => 
{
    ...
    {
        result.push([Branchwise_data_temp[i].User_Details_Name, Branchwise_data_temp[i].Total]);
    ...
    this.Branchwise_columnNames.push('User')
