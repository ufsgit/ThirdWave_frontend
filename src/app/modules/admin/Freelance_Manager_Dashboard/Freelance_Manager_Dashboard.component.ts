...
@Component({
selector: 'app-Freelance_Manager_Dashboard',
templateUrl: './Freelance_Manager_Dashboard.component.html',
styleUrls: ['./Freelance_Manager_Dashboard.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
    ],
})
export class Freelance_Manager_DashboardComponent implements OnInit {
...
debugger
            ...
            this.Student_Service_.Get_Dashboard_Count_Freelancer_Manager(this.Login_User,moment(this.Search_FromDate).format("YYYY-MM-DD"),
...
Click_No2()
{
    ...
    localStorage.setItem("Look_In_Date_From_Freelancer_Dashboard",Look_In_Date.toString());
    localStorage.setItem("Search_FromDate_From_Freelancer_Dashboard",this.Search_FromDate.toString());
    localStorage.setItem("Search_ToDate_From_Freelancer_Dashboard",this.Search_ToDate.toString());
    
      this.router.navigateByUrl('/Registration_Summary_Freelancer');  
}
Click_No3()
{
...
Click_No4()
{
    ...
    localStorage.setItem("Search_FromDate_From_Freelancer_Dashboard",this.Search_FromDate.toString());
    localStorage.setItem("Search_ToDate_From_Freelancer_Dashboard",this.Search_ToDate.toString());
    this.router.navigateByUrl('/Receipt_Summary_Report_Freelancer');
...
Click_No11()
{
    this.router.navigateByUrl('/Freelancer_Amount');
   
}
Click_No12(){
    this.router.navigateByUrl('/Freelancer_User_Amount');
}

Click_No13(){
    this.router.navigateByUrl('/Freelancer_Manager');
}

Freelancer_Entry_View_Click(Page_Check)
{
	localStorage.setItem('Page_Check',Page_Check.toString());

    this.router.navigateByUrl('/Freelancer_Details');
}
