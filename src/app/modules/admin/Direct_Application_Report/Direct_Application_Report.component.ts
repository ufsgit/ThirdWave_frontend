...
@Component({
selector: 'app-Direct_Application_Report',
templateUrl: './Direct_Application_Report.component.html',
styleUrls: ['./Direct_Application_Report.component.css'],
providers:[
...
export class Direct_Application_ReportComponent implements OnInit {
...
debugger
    ...
    this.Student_Service_.Search__direct_Application_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'),
