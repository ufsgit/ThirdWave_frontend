...
@Component({
    selector: "app-Freelancer_Transferred_lead_Data",
    templateUrl: "./Freelancer_Transferred_lead_Data.component.html",
    styleUrls: ["./Freelancer_Transferred_lead_Data.component.css"],
    providers: [
        {
            provide: DateAdapter,
...
export class Freelancer_Transferred_lead_DataComponent implements OnInit {
    ...
    Page_Load() {
        ...
        this.Get_Menu_Status(166, this.Login_User);
...
debugger
        this.Student_Service_.Freelancer_Transferred_lead_Data(
