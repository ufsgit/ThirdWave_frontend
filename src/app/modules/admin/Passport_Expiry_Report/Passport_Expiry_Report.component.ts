...
@Component({
selector: 'app-Passport_Expiry_Report',
templateUrl: './Passport_Expiry_Report.component.html',
styleUrls: ['./Passport_Expiry_Report.component.css'],
providers:[
...
export class Passport_Expiry_ReportComponent implements OnInit {
...
Export()
{
        this.Student_Service_.exportExcel(this.Student_Data_Search,'Passport Expiry Data')
...
Search_Passport_Expiry_Report()
{
    ...
    this.Student_Service_.Search_Passport_Expiry_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), User_Id,this.Login_User, look_In_Date_Value)
.subscribe(Rows => 
{
