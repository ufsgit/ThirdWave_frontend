...
@Component({
selector: 'app-Student_Search',
templateUrl: './Student_Search.component.html',
styleUrls: ['./Student_Search.component.css'],
providers: [
...
export class Student_SearchComponent implements OnInit {
...
Page_Load()
{
  ...
  // this.Search_Student_Report();
   this.Show_FollowUp=false
    ...
    this.Get_Menu_Status(37,this.Login_User);
