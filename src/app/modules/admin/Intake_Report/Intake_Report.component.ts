...
@Component({
  selector: 'app-Intake_Report',
  templateUrl: './Intake_Report.component.html',
  styleUrls: ['./Intake_Report.component.css'],
providers: [
 ...
 export class Intake_ReportComponent implements OnInit {
...
Search_Enquriy_Summary()
{
    ...
    var Intake_Id = 0, Intake_Year_Id = 0,UserType_Value =  0,Country_Id=0;
...
var Entry_type_=0;
    ...
    this.Student_Service_.Search_Intake_Report(Intake_Id, Intake_Year_Id, this.Login_User,this.View_Type_,Entry_type_,UserType_Value,Country_Id).subscribe(Graph_Status => 
{  debugger
    this.issLoading = false;
