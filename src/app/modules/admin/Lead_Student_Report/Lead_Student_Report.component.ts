...
@Component({
    selector: "app-Lead_Student_Report",
    templateUrl: "./Lead_Student_Report.component.html",
    styleUrls: ["./Lead_Student_Report.component.css"],
    providers: [
        {
            provide: DateAdapter,
...
export class Lead_Student_ReportComponent implements OnInit {
    ...
    Search_More_Options() {
        ...
        {
            this.myInnerHeight=this.myInnerHeighttemp-200;
 ...
 console.log('this.Date_Type0: ', this.Date_Type);
...
debugger
        this.Student_Service_.Lead_Search_Student_Report(
