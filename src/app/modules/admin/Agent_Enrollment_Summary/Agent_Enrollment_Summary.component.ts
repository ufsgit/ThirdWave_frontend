...
@Component({
  selector: 'app-Agent_Enrollment_Summary',
  templateUrl: './Agent_Enrollment_Summary.component.html',
  styleUrls: ['./Agent_Enrollment_Summary.component.css'],
providers: [
 ...
 export class Agent_Enrollment_SummaryComponent implements OnInit {
...
Page_Load()
{
  ...
  // this.Search_Student_Report();
   ...
   this.Show_FollowUp=false
    ...
    this.Get_Menu_Status(176,this.Login_User);
...
var User_Id=0,look_In_Date_Value=0,branch_id=0;
   ...
   var c=0;
    ...
    this.Student_Service_.Search_Enrollment_Agent_Summary_Track(moment(this.Search_FromDate).format('YYYY-MM-DD'),
