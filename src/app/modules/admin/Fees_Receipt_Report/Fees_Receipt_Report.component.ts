...
@Component({
selector: 'app-Fees_Receipt_Report',
templateUrl: './Fees_Receipt_Report.component.html',
styleUrls: ['./Fees_Receipt_Report.component.css'],
providers: [
...
export class Fees_Receipt_ReportComponent implements OnInit {
...
Search_Fees_Receipt_Report(User_Id){
    ...
    var value = 1, dept_id=0,search_name_='0',look_In_Date_Value=0,branch_id=0,To_Account_Id=0,Fees_Id=0;
    ...
    this.Student_Service_.Search_Fees_Receipt_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), value, search_name_, dept_id,To_Account_Id,branch_id, User_Id,   look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop,Fees_Id)
.subscribe(Rows => 
{
...
//     this.issLoading = true;
//     
//     this.Student_Service_.Search_Student_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), value, search_name_, dept_id,branch_id, User_Id,   look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop)
// .subscribe(Rows => 
// {
//     
//     log(Rows)
...
this.Student_Service_.Get_Lead_Load_Data().subscribe(Rows => {
    ...
    if (Rows != undefined)
    {
        ...
        // this.Fees_Receipt_Temp.Description="All";
        // this.Fees_Receipt_Data.unshift(Object.assign({}, this.Fees_Receipt_Temp));
        // this.Fees_Description_Search = this.Fees_Receipt_Data[0];

        // this.Fees_Receipt_Temp.Amount=0;
        // this.Fees_Receipt_Data.unshift(Object.assign({}, this.Fees_Receipt_Temp));
        // this.Fees_Amount_Search = this.Fees_Receipt_Data[0];
