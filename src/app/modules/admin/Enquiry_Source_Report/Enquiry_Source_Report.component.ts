...
@Component({
selector: 'app-Enquiry_Source_Report',
templateUrl: './Enquiry_Source_Report.component.html',
styleUrls: ['./Enquiry_Source_Report.component.css'],
providers: [
...
export class Enquiry_Source_ReportComponent implements OnInit {
...
.subscribe(Graph_Status => 
{
    ...
    {
        result.push([Branchwise_data_temp[i].Enquiry_Source_Name, Branchwise_data_temp[i].Data_Count]);
    } 
