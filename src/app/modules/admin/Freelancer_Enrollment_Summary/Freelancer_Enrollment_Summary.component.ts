...
@Component({
  selector: 'app-Freelancer_Enrollment_Summary',
  templateUrl: './Freelancer_Enrollment_Summary.component.html',
  styleUrls: ['./Freelancer_Enrollment_Summary.component.css'],
providers: [
 ...
 export class Freelancer_Enrollment_SummaryComponent implements OnInit {
...
Page_Load()
{
  ...
  // this.Search_Student_Report();
   ...
   this.Show_FollowUp=false
    ...
    this.Get_Menu_Status(177,this.Login_User);
...
var User_Id=0,look_In_Date_Value=0,branch_id=0;
   ...
   var c=0;
    ...
    this.Student_Service_.Search_Enrollment_Freelancer_Summary_Track(moment(this.Search_FromDate).format('YYYY-MM-DD'),
