...
@Component({
selector: 'app-Agent_StudentDetails',
templateUrl: './Agent_Student_Details.component.html',
styleUrls: ['./Agent_Student_Details.component.css'],
providers: [
...
export class Agent_StudentDetailsComponent implements OnInit {
...
var value = 1, dept_id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
 var File_Status_Value=0;
    ...
    // branch_id = this.Search_Branch.Branch_Id;
						...
						if (this.Is_File_Status != undefined && this.Is_File_Status != null)
							if (
								this.Is_File_Status != undefined &&
								this.Is_File_Status != null &&
								this.Is_File_Status != ""
							)
							File_Status_Value = this.Is_File_Status;

    this.issLoading = true;
    debugger
    this.Student_Service_.View_Detail_agent_Details( dept_id,branch_id,User_Id,this.Login_User,File_Status_Value)
.subscribe(Rows => 
{
    debugger
    //log(Rows)
...
FollowUp_Summary()
{
    ...
    this.Student_Service_.Agent_Search_data_Details(User_Id,this.Login_User)
.subscribe(Rows => 
{
    debugger
    //log(Rows)
