...
templateUrl: './Agent_Summary.component.html',
styleUrls: ['./Agent_Summary.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
    ],
})
export class Agent_SummaryComponent implements OnInit {
    Permissions: any;
...
Export()
{
        this.Student_Service_.exportExcel(this.Student_Data_Search,'Agent_Summary')
...
Search_Enquriy_Summary()
{
   ...
   var c=0;
    ...
    this.Student_Service_.Search_Agent_Summary_Track(moment(this.Search_FromDate).format('YYYY-MM-DD'),
