...
@Component({
  selector: 'app-Enquiry_Conversion',
  templateUrl: './Enquiry_Conversion.component.html',
  styleUrls: ['./Enquiry_Conversion.component.css'],
providers: [
 ...
 export class Enquiry_ConversionComponent implements OnInit {
...
Page_Load()
{
  ...
  // this.Search_Student_Report();
   ...
   this.Show_FollowUp=false
    ...
    this.Get_Menu_Status(52,this.Login_User);
...
var User_Id=0,look_In_Date_Value=0,branch_id=0;
   ...
   var c=0;
    ...
    this.Student_Service_.Search_Enquiry_Conversion(moment(this.Search_FromDate).format('YYYY-MM-DD'),
