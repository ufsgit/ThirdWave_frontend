...
@Component({
selector: 'app-Registration_Summary_Agent',
templateUrl: './Registration_Summary_Agent.component.html',
styleUrls: ['./Registration_Summary_Agent.component.css'],
providers: [
...
export class Registration_Summary_AgentComponent implements OnInit {
    ...
    Look_In_Date_From_Agent_Dashboard:number=2;
    Search_FromDate_From_Agent_Dashboard: Date = new Date();
    Search_ToDate_From_Agent_Dashboard: Date  = new Date();
...
ngOnInit() 
{
  debugger
    ...
    this.Look_In_Date_From_Agent_Dashboard = Number(localStorage.getItem("Look_In_Date_From_Agent_Dashboard"));
    localStorage.setItem("Look_In_Date_From_Agent_Dashboard","2");

    if(this.Look_In_Date_From_Agent_Dashboard === 1)
    {
        this.Search_FromDate_From_Agent_Dashboard = new Date(localStorage.getItem("Search_FromDate_From_Agent_Dashboard"))
        this.Search_ToDate_From_Agent_Dashboard = new Date(localStorage.getItem("Search_ToDate_From_Agent_Dashboard"))
        this.Look_In_Date = true;
    }
    else if(this.Look_In_Date_From_Agent_Dashboard === 0)
    {
        this.Search_FromDate_From_Agent_Dashboard = new Date(localStorage.getItem("Search_FromDate_From_Agent_Dashboard"))
        this.Search_ToDate_From_Agent_Dashboard = new Date(localStorage.getItem("Search_ToDate_From_Agent_Dashboard"))
...
Page_Load()
{
    ...
    if(this.Look_In_Date_From_Agent_Dashboard === 0 || this.Look_In_Date_From_Agent_Dashboard === 1)
        {
            this.Search_FromDate = this.Search_FromDate_From_Agent_Dashboard;
            this.Search_ToDate = this.Search_ToDate_From_Agent_Dashboard;
        }
        else
        {
    ...
    this.Get_Menu_Status(152,this.Login_User);
...
Search_Lead_button1() 
{
    ...
    this.Total_Rows=0;
    this.Red_Stop = this.Page_Length_;
    this.Search_Registration_Report(this.Agent_Id);
}
Search_More_Options()
{
...
this.Agent_Id=User_Details_Id;
this.View_Branch   =ViewBranch;
this.Search_Registration_Report(User_Details_Id)
}
...
var value = 1, dept_id=0,User_Id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
    ...
    debugger
    this.Student_Service_.Student_Registration_Summary_Agent(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), branch_id, look_In_Date_Value,this.Login_User)
.subscribe(Rows => 
{debugger
...
// alert (User_Id);
    ...
    this.Student_Service_.Search_Registration_Report_Agent(moment(this.Search_FromDate).format('YYYY-MM-DD'),
     moment(this.Search_ToDate).format('YYYY-MM-DD'), value, search_name_, dept_id,branch_id, User_Id,  
     look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop,this.View_Branch)
.subscribe(Rows => 
{
