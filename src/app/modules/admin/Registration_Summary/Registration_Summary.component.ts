...
@Component({
selector: 'app-Registration_Summary',
templateUrl: './Registration_Summary.component.html',
styleUrls: ['./Registration_Summary.component.css'],
providers: [
...
export class Registration_SummaryComponent implements OnInit {
