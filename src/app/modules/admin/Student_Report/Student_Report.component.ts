...
@Component({
    selector: "app-Student_Report",
    templateUrl: "./Student_Report.component.html",
    styleUrls: ["./Student_Report.component.css"],
    providers: [
        {
            provide: DateAdapter,
...
export class Student_ReportComponent implements OnInit {
...
debugger
        this.Student_Service_.Search_Student_Report(
    ...
    Get_Lead_Load_Data_ByUser(Login_User) {
        ...
        this.Student_Service_.Get_Lead_Load_Data_ByUser(Login_User).subscribe(
            (Rows) => {
                ...
                this.Users_Data1 = Rows[16].slice();
                ...
                this.User_Search1 = this.Users_Data1[0];
        ...
        //    }
        {
            ...
            this.Student_Service_.Save_Student_Report_FollowUp(
                ...
                (Save_status) => {
                    ...
                    this.issLoading = false;
   console.log('Save_status[0][0]: ', Save_status[0][0]);
                    // log(Save_status[0][0])
    ...
    Delete_Student() {
        ...
        dialogRef.afterClosed().subscribe((result) => {
            ...
            if (result == "Yes") {
                for (var m = 0; m < this.Student_Data_Search.length; m++) {
                    console.log('Student_Data_Search: ', this.Student_Data_Search);
                    if (Boolean(this.Student_Data_Search[m].Check_Box_View) == true) {
                        //Status=true
                        //this.Student_Selection_Data_Temp.push(this.Student_Data[m]);
                ...
                this.Student_.Delete_Data_Details = Student_Deatils;
                      this.Student_.By_User_Id = parseInt(this.Login_User);
                      console.log('this.Student_.By_User_Id: ', this.Student_.By_User_Id);
            ...
            debugger
                this.Student_Service_.Delete_Student_Report(this.Student_).subscribe(
                    (Delete_Status) => {
                        ...
                        debugger
                               console.log('Delete_Status[0][0]: ', Delete_Status[0][0]);
                                           console.log('(Delete_Status[0][0].Student_Id_J: ', (Delete_Status[0][0].Student_Id_J));
                        this.issLoading = false;
