...
@Component({
selector: 'app-Department_Report',
templateUrl: './Department_Report.component.html',
styleUrls: ['./Department_Report.component.css'],
providers:[
...
export class Department_ReportComponent implements OnInit {
...
Export()
{
        this.Student_Service_.exportExcel(this.Student_Data_Search,'Department Details Report')

}
Export_Summary()
{
        this.Student_Service_.exportExcel(this.Department_Data_Search,'Department Report')
...
debugger
    ...
    this.Student_Service_.Search_Department_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), User_Id,this.Login_User, look_In_Date_Value,dept_id)
.subscribe(Rows => 
{
...
View_Details_Click(Department_Id_e){
    //this.issLoading =true;
    ...
    console.log('Department_Id_e: ', Department_Id_e);
    ...
    // }
    this.Search_Main_report(Department_Id_e);
}
...
Search_Main_report(User_Id)
{
    ...
    this.Graph=false
var value = 1, dept_id=0,search_name_='0',look_In_Date_Value=0,branch_id=0,status_id=0,Class_id=0;
    if(this.Search_By_!=undefined && this.Search_By_!=null)
    if (this.Search_By_ != undefined && this.Search_By_ != null && this.Search_By_ != '')
    value=this.Search_By_;
    ...
    this.Student_Service_.Search_Department_Details_report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'),
     value, search_name_, dept_id,Class_id, User_Id,look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop,status_id)
.subscribe(Rows => 
{
    debugger
