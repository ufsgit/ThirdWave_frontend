...
@Component({
    selector: "app-Student_Data_Report",
    templateUrl: "./Student_Data_Report.component.html",
    styleUrls: ["./Student_Data_Report.component.css"],
    providers: [
        {
            provide: DateAdapter,
...
export class Student_Data_ReportComponent implements OnInit {
    ...
    Page_Load() {
        ...
        this.Get_Menu_Status(168, this.Login_User);
...
debugger
        this.Student_Service_.Student_data_Search_Report(
