...
@Component({
	selector: "app-Fees_Pending_Report",
	templateUrl: "./Fees_Pending_Report.component.html",
	styleUrls: ["./Fees_Pending_Report.component.css"],
	providers: [
		{
			provide: DateAdapter,
...
export class Fees_Pending_ReportComponent implements OnInit {
