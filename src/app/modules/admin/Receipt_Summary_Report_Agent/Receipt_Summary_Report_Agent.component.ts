...
@Component({
selector: 'app-Receipt_Summary_Report_Agent',
templateUrl: './Receipt_Summary_Report_Agent.component.html',
styleUrls: ['./Receipt_Summary_Report_Agent.component.css'],
providers: [
...
export class Receipt_Summary_Report_AgentComponent implements OnInit {
...
Page_Load()
{
    ...
    this.Get_Menu_Status(151,this.Login_User);
...
Search_Fees_Receipt_Report(User_Id){
    ...
    this.Student_Service_.Search_Fees_Receipt_Report_Agent(moment(this.Search_FromDate).format('YYYY-MM-DD'), 
...
var value = 1, dept_id=0,User_Id=0,search_name_='0',look_In_Date_Value=0,branch_id=0;
    ...
    this.Student_Service_.Search_Userwise_Summary_Agent(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), value, search_name_, dept_id,branch_id, User_Id,   look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop)
.subscribe(Rows => 
{
