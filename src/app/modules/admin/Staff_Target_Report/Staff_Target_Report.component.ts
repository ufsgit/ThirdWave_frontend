...
@Component({
selector: 'app-Staff_Target_Report',
templateUrl: './Staff_Target_Report.component.html',
styleUrls: ['./Staff_Target_Report.component.css'],
providers: [
...
export class Staff_Target_ReportComponent implements OnInit {
...
//     if (this.Search_Remark.Remarks_Id != undefined && this.Search_Remark.Remarks_Id != null)
//    var remarks_Id = this.Search_Remark.Remarks_Id;


//     this.issLoading = true;
    
//     this.Student_Service_.Search_Student_Report(moment(this.Search_FromDate).format('YYYY-MM-DD'), moment(this.Search_ToDate).format('YYYY-MM-DD'), value, search_name_, dept_id,branch_id, User_Id,   look_In_Date_Value, this.Black_Start, this.Black_Stop, this.Login_User, this.Red_Start, this.Red_Stop,remarks_Id)
// .subscribe(Rows => 
// {
