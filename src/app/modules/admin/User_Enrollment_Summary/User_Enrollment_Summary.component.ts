...
@Component({
  selector: 'app-User_Enrollment_Summary',
  templateUrl: './User_Enrollment_Summary.component.html',
  styleUrls: ['./User_Enrollment_Summary.component.css'],
providers: [
 ...
 export class User_Enrollment_SummaryComponent implements OnInit {
...
Page_Load()
{
  ...
  // this.Search_Student_Report();
   ...
   this.Show_FollowUp=false
    ...
    this.Get_Menu_Status(175,this.Login_User);
...
Export()
{
        this.Student_Service_.exportExcel(this.Student_Data_Search,'Enquiry_Conversion')
...
var User_Id=0,look_In_Date_Value=0,branch_id=0,UserType_Value =  0;;
   ...
   var c=0;
    ...
    this.Student_Service_.Search_Enrollment_User_Summary_Track(moment(this.Search_FromDate).format('YYYY-MM-DD'),
    moment(this.Search_ToDate).format('YYYY-MM-DD'),this.Login_User,look_In_Date_Value,branch_id,UserType_Value)
