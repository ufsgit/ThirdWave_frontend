...
export class Application_ReportComponent implements OnInit {
    ...
    Users_Temp2: User_Details = new User_Details();
    Users_Data2: User_Details[]
    User_Search2: User_Details = new User_Details();
    To_User_Search2: User_Details = new User_Details();
...
Search_Application_Report()
{
    ...
    this.Search_Div=true
    this.Graph=false
var value = 1,Intake_Id=0,Intake_Year_Id=0,Country_Id=0,University_Id=0,Course_Id=0, dept_id=0,Status_Value=1,
search_name_='0',look_In_Date_Value=0,branch_id=0,User_Id=0,Agent_Id=0,Active_In_Vlaue=0,Application_status_Id=0,To_User_Id=0,
Subordinators_id=0;
    ...
    console.log('this.To_User_Search: ', this.To_User_Search);
    if (this.To_User_Search != undefined && this.To_User_Search!=null)
        ...
        To_User_Id = this.To_User_Search.User_Details_Id;
    console.log('this.To_User_Search.User_Details_Id: ', this.To_User_Search.User_Details_Id);

    if (this.To_User_Search2 != undefined && this.To_User_Search2!=null)
        if (this.To_User_Search2.User_Details_Id != undefined && this.To_User_Search2.User_Details_Id != null)
            Subordinators_id = this.To_User_Search2.User_Details_Id;
...
debugger
    ...
    branch_id, User_Id,look_In_Date_Value, this.Login_User,Status_Value, Agent_Id,Application_status_Id,Intake_Id,Intake_Year_Id,Country_Id,University_Id,Active_In_Vlaue,To_User_Id,Course_Id,Subordinators_id)
.subscribe(Rows =>
{
...
Get_Lead_Load_Data_ByUser(Login_User)
   ...
   console.log('Rows[18]111: ', Rows[18]);
   ...
   console.log('this.To_User_SearchHHHH: ', this.To_User_Search);
   
   this.Users_Data2 = Rows[17].slice();
   this.Users_Temp2.User_Details_Id = 0;
   this.Users_Temp2.User_Details_Name = "All";
   this.Users_Data2.unshift(Object.assign({},this.Users_Temp1));
   this.User_Search2 = this.Users_Data2[0];
   this.To_User_Search2= this.Users_Data2[0];
...
goToLink() {
  ...
  More_Options_button()
  {
    ...
    this.myTotalHeight = this.myTotalHeight -180
  }
